...
b. Generate a 95% confidence interval for the coefficient associated with `Sex`.  
c. Fit a model with a polynomial of degree 2 in the `GPA`.  
d. Try to add different predictors to come up with your best model.  
e. Generate a confusion matrix for the best model you have developed.  
f. Find a 95% confidence interval for the probability a female student with a 3.5 GPS, a `BCPM` of 3.8, a verbal reasoning score of 10, a physical sciences score of 9, a writing sample score of 8, a biological score of 10, a MCAT score of 40, and who applied to 5 medical schools.  
